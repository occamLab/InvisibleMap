...
extension ARView: ARSCNViewDelegate {
    func renderer(_ renderer: SCNSceneRenderer, nodeFor anchor: ARAnchor) -> SCNNode? {
        ...
        // aprilTagDetectionDictionary, tag, scenePoseQuat, scenePoseTranslation, sceneQuatVar, sceneTransVar
...
*/
/*
extension ContentView: ARViewController {
    ...
    func detectTagFound(aprilTagDetectionDictionary: Dictionary<Int, AprilTagTracker>, tag: AprilTags, cameraTransform: simd_float4x4) {
        ...
        return aprilTagDetectionDictionary, tag, doKalman, scenePoseQuat, scenePoseTranslation, sceneQuatVar, sceneTransVar
